...
| :-- | :-- | :-- |
| 09/12-HTML、CSS、RWD 切版實務  | 1 資料庫處理、AWS 雲端服務 | 前端、或後端技術深入研究 |
| 09/19-JavaScript、Python 基本練習  | 2 景點 API 與網站首頁呈現 | 個人專案發想與準備 |
| 09/26-JavaScript、Python 網路連線與資料運用  | 3 景點頁面、互動輪播效果開發 | 第一個 Sprint：完成核心功能 |
| 10/03-架設 Flask 網站後端伺服器  | 4 會員功能整合 | 第二個 Sprint：完成核心流程 |
| 10/10-架設 MySQL 資料庫伺服器  | 5 預定行程功能整合 | 第三個 Sprint：完成週邊功能 |
| 10/17-基礎會員系統開發  | 6 金流串接：導覽服務購買 | 第四個 Sprint：完成周邊流程 |
| 10/24-前端 AJAX、後端 API 整合功能開發  | 7 系統優化：優化前端版面流程、後端資料庫 | 第五個 Sprint：專案除錯、優化 |
| 10/31-主題學習，實體活動，轉職經驗分享  | 8 多人合作開發練習、職場經驗分享 | 第六個 Sprint：最終成品收尾 |
| - | - | 9 履歷撰寫、面試練習、解題練習 |
| | - | 10 資深工程師模擬面試練習 |
